...
EPISODE_TIMEOUT_SECONDS = 75    # Number of seconds after which episode timeout occurs
...
REAL_TOPIC_SCAN  = 'scan_downsampled'
...
REAL_THRESHOLD_COLLISION    = 0.1  # meters, minimum distance to an object that counts as a collision
...
OBSERVE_STEPS   = 25      # At training start random actions are taken for N steps for better exploration
